 ...
 * {@inheritdoc}
 */
class InstitutionsBreadcrumb implements BreadcrumbBuilderInterface {
  ...
  public function applies(RouteMatchInterface $route_match) {
    ...
    if (!empty($this->node)) {
      ...
      if ($this->node->bundle() == 'institutions') {
        $match = TRUE;
      }
    }
  ...
  public function build(RouteMatchInterface $route_match) {
    ...
    $links[] = Link::fromTextandUrl(t('Institutions'), Url::fromRoute('view.institutions_search.institutions_search_page'));
